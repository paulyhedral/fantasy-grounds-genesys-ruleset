...
function onDrag(button, x, y, draginfo)
	...
	if not dragging then
		...
		elseif weaponskillvalue == "RH" then
			weaponskillname1 = "Ranged-Heavy (Ag)";
			weaponskillname2 = "Ranged-Heavy";		
		...
		elseif weaponskillvalue == "MH" then
			weaponskillname1 = "Melee-Heavy (Br)";
			weaponskillname2 = "Melee-Heavy";
		elseif weaponskillvalue == "ML" then
			weaponskillname1 = "Melee-Light (Br)";
			weaponskillname2 = "Melee-Light";
		elseif weaponskillvalue == "R" then
			weaponskillname1 = "Ranged (Ag)";
			weaponskillname2 = "Ranged";
		else
